...
if ( ! function_exists( 'oleinpress_setup' ) ) :
	...
	function oleinpress_setup() {
		 ...
		 * If you're building a theme based on oleinpress, use a find and replace
		 * to change 'oleinpress' to the name of your theme in all the template files.
		 */
		...
		add_theme_support( 'custom-background', apply_filters( 'oleinpress_custom_background_args', array(
